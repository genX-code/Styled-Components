...
export const getMakeTweets = () => dispatch => {
  axios.get(`https://rtweeted.herokuapp.com:${process.env.PORT}/tweets`)
    .then(response => {
      make = response.data;
...
export const getYTweets = () => dispatch => {
  axios.get(`https://rtweeted.herokuapp.com:${process.env.PORT}/tweets/ycomb`)
    .then(response => {
      y = response.data;
...
export const getNewsTweets = () => dispatch => {
  axios.get(`https://rtweeted.herokuapp.com:${process.env.PORT}/tweets/news`)
    .then(response => {
      news = response.data;
