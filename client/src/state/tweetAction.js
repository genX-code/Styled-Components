...
export const getMakeTweets = () => dispatch => {
  axios.get(encodeURI(`https://warm-dusk-72486.herokuapp.com/tweets`))
    .then(response => {
      make = response.data;
...
export const getYTweets = () => dispatch => {
  axios.get(encodeURI(`https://warm-dusk-72486.herokuapp.com/tweets/ycomb`))
    .then(response => {
      y = response.data;
...
export const getNewsTweets = () => dispatch => {
  axios.get(encodeURI(`https://warm-dusk-72486.herokuapp.com:/tweets/news`))
    .then(response => {
      news = response.data;
